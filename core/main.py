...
def main():
    ...
    # Neue Default-Werte einmalig in bestehende Installationen nachziehen (#317) — nach
    # seed_defaults(), damit eine frische DB nur den Marker bekommt.
    settings_manager.run_data_migrations()
